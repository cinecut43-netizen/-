/* ============================================================
   ШАБАШКА — уведомление об использовании cookie и localStorage
   (152-ФЗ). Подключается тегом <script src="/cookie-banner.js">
...
(function () {
  ...
  function init() {
    ...
    banner.innerHTML =
      ...
      'Сайт использует cookie-файлы для входа в аккаунт и localStorage браузера для хранения настроек и черновиков. ' +
